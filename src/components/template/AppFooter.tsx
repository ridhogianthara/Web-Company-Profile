        ...
        <footer className="w-full bg-gray-800 text-white py-4 px-10">
            <div className="flex items-center justify-center py-4 gap-4">
                <div className="w-1/3 flex flex-col">
                    <h2 className="text-xl font-bold mb-2">DNAtek</h2>
                    ...
                    <p className="text-sm text-gray-400 mt-2">Hubungi kami di: <a href="mailto:lumino@example.com" className="text-indigo-500 hover:underline">DNAtek@example.com</a></p>
                </div>
            ...
            <div className="container mx-auto text-center pt-4 border-t border-gray-700">
                <p className="text-sm">© {new Date().getFullYear()} DNAtek. All rights reserved.</p>
                <p className="text-xs mt-2">Made with ❤️ by DNAtek Team</p>
            </div>
        </footer>
    )
}
